...
class create_mask():
    ...
    def __init__(self,rot,*board):
        ...
        # EXIT AND SAVE BUTTON, PARALEL MASK MANAGER
...
class Menu():
    ...
    # make a current mask to be opened and destroy the remaining ones, when open just copy board and print, reset width and height
